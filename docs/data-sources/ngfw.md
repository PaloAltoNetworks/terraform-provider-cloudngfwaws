...
- `security_zones` (List of Object) (see [below for nested schema](#nestedatt--security_zones))
...
- `endpoint_id` (String)
- `mode` (String)
- `prefixes` (List of Object) (see [below for nested schema](#nestedobjatt--security_zones--prefixes))
- `rejected_reason` (String)
- `status` (String)
- `subnet_id` (String)
- `vpc_id` (String)
...
<a id="nestedobjatt--security_zones--prefixes"></a>
### Nested Schema for `security_zones.prefixes`

Read-Only:

- `private_prefix` (List of Object) (see [below for nested schema](#nestedobjatt--security_zones--prefixes--private_prefix))

<a id="nestedobjatt--security_zones--prefixes--private_prefix"></a>
